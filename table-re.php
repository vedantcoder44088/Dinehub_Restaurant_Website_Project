...
<head>
    ...
    <link rel="stylesheet" href="css/table-re.css">
...
<body>
    ...
    <div class="container-main-2 col-12">
        <div class="form-book-table col-12">
            <form action="tablebook.php" method="post" class="reservation-form">
                <h1 class="header">Book a table</h1>
                <h1 class="subheader">Make Reservation</h1>
                ...
                <div class="row-1">
                    ...
                    <div class="input-field col-6">
                        ...
                        <input type="text" name="number" id="number" placeholder="Enter Number" inputmode="numeric">
                    </div>
                </div>
                ...
                <div class="row-2">
                    <div class="input-field col-6">
                        ...
                        <input type="text" placeholder="MM/DD/YYYY" onfocus="(this.type='date')" name="date">
                    </div>
    
                    <div class="input-field col-6">
                        <label for="Time">Time</label>
                        <input type="text" placeholder="Time" onfocus="(this.type='Time')" name="time">
                    </div>
                </div>
                ...
                <div class="row-3">
                    <div class="input-field col-12">
                        ...
                        <input type="number" name="person" id="date" placeholder="Enter Date">
                    </div>
                </div>
